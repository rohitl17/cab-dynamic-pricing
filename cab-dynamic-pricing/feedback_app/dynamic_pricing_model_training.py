...
class PricePredictModel:
    def __init__(self):
        ...
        Xuber_train = self.uber_train[['source_lat', 'source_long', 'dest_lat',
                                       'dest_long', 'distance', 'surge_multiplier',
                                       'Black', 'Black SUV', 'UberPool', 'UberX', 'UberXL', 
                                       'WAV']]
        Yuber_train = self.uber_train['price']
        
        Xuber_test = self.uber_test[['source_lat','source_long', 'dest_lat', 
                                     'dest_long', 'distance', 'surge_multiplier', 
                                     'Black', 'Black SUV', 'UberPool', 'UberX', 
                                     'UberXL', 'WAV']]
        Yuber_test = self.uber_test['price']
        
        Xlyft_train = self.lyft_train[['source_lat','source_long', 'dest_lat', 'dest_long', 
                                       'distance', 'surge_multiplier', 'Lux', 'Lux Black', 
                                       'Lux Black XL', 'Lyft', 'Lyft XL', 'Shared']]
        Ylyft_train = self.lyft_train['price']
        
        Xlyft_test = self.lyft_test[['source_lat','source_long', 'dest_lat', 'dest_long',
                                     'distance', 'surge_multiplier', 'Lux', 'Lux Black', 
                                     'Lux Black XL', 'Lyft', 'Lyft XL', 'Shared']]
